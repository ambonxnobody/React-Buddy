...
function Profile() {
    ...
    return (
        <Layout>
            <div className="pt-5 px-5 row" style={{ width: "99vw", height: "94vh" }}>
                <div className="col-12 col-md-3 mb-5">
                    <div className="card">
                        <div className="card-header d-flex flex-column align-items-center pt-5" style={{ backgroundColor: "white" }}>
                            <img src="https://dummyimage.com/1000x1000/0086CF/dee2e6&text=I" className="mb-3" alt="Photo Profile" style={{ height: "150px", width: "150px", borderRadius: "100%" }} />
                ...
                <div className="col-12 col-md-9 mb-5">
                    <div className="card" style={{ paddingTop: "1rem", paddingBottom: "1rem" }}>
                        ...
                        <div className="card-body px-5">
                            <div className="row mb-3">
                                <div className="col-12 col-md-6">
                                    ...
                                    <input disabled={!editProfile} type="text" className="form-control" id="namaLengkap" />
                                </div>
                                <div className="col-12 col-md-6">
                                    <label htmlFor="email" className="form-label">Email</label>
                                    <input disabled={!editProfile} type="email" className="form-control" id="email" />
                                </div>
                            </div>
                            <div className="row mb-3">
                                <div className="col-12 col-md-6">
                                    <label htmlFor="noTeleponAktif" className="form-label">No. Telepon Aktif</label>
                                    <input disabled={!editProfile} type="text" className="form-control" id="noTeleponAktif" />
                                </div>
                            </div>
                            <div className="row mb-3">
                                <div className="col-12 col-md-6">
                                    <label htmlFor="kataSandi" className="form-label">Kata Sandi</label>
                                    <div style={{ position: 'relative' }}>
                                        <input disabled={!editProfile} type={showPassword ? 'text' : 'password'} className="form-control" id="kataSandi" />
                                        {editProfile ?
                            ...
                            <div className="row mb-3">
                                <div className="col-12 col-md-6">
                                    <label htmlFor="konfirmasiKataSandi" className="form-label">Konfirmasi Kata Sandi</label>
                                    <div style={{ position: 'relative' }}>
                                        <input disabled={!editProfile} type={showConfirmPassword ? "text" : "password"} className="form-control" id="konfirmasiKataSandi" />
                                        {editProfile ?
                        ...
                        <div className="card-footer px-5" style={{ backgroundColor: "white" }}>
                            <button disabled={!editProfile} className="btn btn-primary">Ubah Profile</button>
                        </div>
                    </div>
                </div>
            </div>
